...
export interface TokenUnidirectionalUpgradeableEvent {
  eventName: string
  args: unknown
  address: `0x${string}`
  blockHash: `0x${string}`
...
export enum TokenUnidirectionalUpgradeableEventName {
  DidClaim = 'DidClaim',
...
export class TokenUnidirectionalUpgradeableContract extends BaseContractViem {
  ...
  static hasEvent(
    ...
    eventName: TokenUnidirectionalUpgradeableEventName,
  ): boolean {
  ...
  static parseEvents(
    receipt: TransactionReceipt,
  ): TokenUnidirectionalUpgradeableEvent[] {
