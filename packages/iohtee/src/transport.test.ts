...
//           reqheaders: { 'X-Header': expectedResponse },
//         })
//           .get('/path')
//           .reply(200, expectedResponse)
//
//         return t
//           .get('http://example.com/path', { 'X-Header': expectedResponse })
//           .then((response) => {
//             expect(response.body).toBe(expectedResponse)
//           })
//       })
...
//         nock('http://example.com', {
//           reqheaders: { authorization: `Paywall ${expectedToken}` },
//         })
//           .get('/path')
//           .reply(200, expectedResponse)
//
//         return t
//           .getWithToken('http://example.com/path', expectedToken)
//           .then((response) => {
//             expect(response.body).toBe(expectedResponse)
//           })
//       })
...
//         return t
//           .requestToken('http://example.com/path', payment)
//           .then((token) => {
...
//       }
//       let paymentRequired =
//         PaymentRequiredResponseSerializer.instance.deserialize(headers)
