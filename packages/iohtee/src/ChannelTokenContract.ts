...
//     this.web3 = web3
//     this.contract = contracts.TokenUnidirectional.contract(
...
//     settlementPeriod: number | BigNumber,
//     tokenContract: string,
//     channelId?: ChannelId | string,
//   ): Promise<TransactionResult> {
//     log.info(
//       `Creating channel. Value: ${value} / Settlement: ${settlementPeriod}`,
//     )
//     let _channelId = channelId || ChannelId.random()
//     const standardTokenContract = contracts.StandardToken.contract(
//       this.web3.currentProvider,
//     ).at(tokenContract)
//     const deployedTokenUnidirectional = await this.contract
//     const deployedStandardTokenContract = await standardTokenContract
//
//     const approveTx = await deployedStandardTokenContract.approve(
//       deployedTokenUnidirectional.address,
//       value,
//       { from: sender },
//     )
//     if (contracts.StandardToken.isApprovalEvent(approveTx.logs[0])) {
//       return deployedTokenUnidirectional.open(
//         _channelId.toString(),
//         receiver,
//         new BigNumber(settlementPeriod),
//         tokenContract,
//         value,
//         {
//           from: sender,
...
//   ): Promise<TransactionResult> {
//     log.info(
//       `Claiming channel with id ${channelId} on behalf of receiver ${receiver}`,
//     )
//     log.info(`Values: ${value} / Signature: ${signature.toString()}`)
//     const deployed = await this.contract
//     return deployed.claim(channelId, value, signature.toString(), {
//       from: receiver,
//       gas: CREATE_CHANNEL_GAS,
//     })
//   }
...
//   ): Promise<TransactionResult> {
//     log.info(
//       `Starting settle for account ${account} and channel id ${channelId}.`,
//     )
//     const deployed = await this.contract
...
//   ): Promise<TransactionResult> {
//     log.info(
//       `Finishing settle for account ${account} and channel ID ${channelId}.`,
//     )
//     const deployed = await this.contract
