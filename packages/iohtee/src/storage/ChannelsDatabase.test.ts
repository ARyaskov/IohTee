...
//         undefined,
//       )
//       const updatedPaymentChannel = new PaymentChannel(
//         'sender',
//         'receiver',
//         hexChannelId,
//         new BigNumber(3),
...
//       expect(
//         found.map((p) => p.channelId).includes(channelId.toString()),
//       ).toBeTruthy()
//     })
//   })
//
...
//       const paymentChannel1 = new PaymentChannel(
//         'sender',
//         'receiver',
//         hexChannelId1,
//         new BigNumber(10),
...
//         '',
//       )
//       const paymentChannel2 = new PaymentChannel(
//         'sender',
//         'receiver',
//         hexChannelId2,
//         new BigNumber(10),
...
//             found
//               .map((p) => p.channelId)
//               .includes(paymentChannel2.channelId.toString()),
//           ).toBeTruthy()
//         })
//     })
//   })
...
//         '',
//       )
//       const paymentChannel3 = new PaymentChannel(
//         'sender',
//         'receiver',
//         hexChannelId3,
//         new BigNumber(10),
...
//             found
//               .map((p) => p.channelId)
//               .includes(paymentChannel1.channelId.toString()),
//           ).toBeTruthy()
//         })
//     })
//   })
