...
//       expect(
//         ethUnidirectional.open.calledWith(
//           SENDER,
//           RECEIVER,
//           VALUE,
//           SETTLEMENT_PERIOD,
...
//       )
//       expect(
//         tokenUnidirectional.open.calledWith(
//           SENDER,
//           RECEIVER,
//           VALUE,
//           SETTLEMENT_PERIOD,
...
//       expect(
//         ethUnidirectional.claim.calledWith(RECEIVER, ID, VALUE, SIGNATURE),
//       ).toBeTruthy()
//     })
//
...
//       await contract.claim(RECEIVER, ID, VALUE, SIGNATURE)
//       expect(
//         tokenUnidirectional.claim.calledWith(RECEIVER, ID, VALUE, SIGNATURE),
//       ).toBeTruthy()
//     })
//   })
//
...
//       expect(
//         ethUnidirectional.deposit.calledWith(SENDER, ID, VALUE),
//       ).toBeTruthy()
//     })
//
...
//       expect(
//         tokenUnidirectional.deposit.calledWith(
//           SENDER,
//           ID,
//           VALUE,
//           TOKEN_CONTRACT,
...
//       await contract.startSettle(SENDER, ID)
//       expect(
//         tokenUnidirectional.startSettle.calledWith(SENDER, ID),
//       ).toBeTruthy()
//     })
//   })
//
...
//       await contract.finishSettle(SENDER, ID)
//       expect(
//         tokenUnidirectional.finishSettle.calledWith(SENDER, ID),
//       ).toBeTruthy()
//     })
//   })
//
...
//       await contract.paymentDigest(ID, VALUE)
//       expect(
//         tokenUnidirectional.paymentDigest.calledWith(ID, VALUE),
//       ).toBeTruthy()
//     })
//
...
//       expect(
//         ethUnidirectional.canClaim.calledWith(ID, VALUE, RECEIVER, SIGNATURE),
//       ).toBeTruthy()
//     })
//
...
//       expect(
//         tokenUnidirectional.canClaim.calledWith(ID, VALUE, RECEIVER, SIGNATURE),
//       ).toBeTruthy()
//     })
//
